...
public class FinallyForm implements Form {

	private final Object form;

	public FinallyForm(Object form) {
		this.form = form;
	}
	
	@Override
	public DeferredCompilation compileForm(CompilerState compilerState) {
		throw error("Should not directly compile finally form");
	}

	@Override
	public Object evaluateForm(CompilerState cs) throws Throwable {
		throw error("Should not directly evaluated finally form");
